...
test_that("the `fmt_number()` function works with conditional `rows`", {
  ...
  expect_equal(
    ...
    c("1836.23", "2763.39", "937.2900", "643.0000", "212.2320", "0.0000", "-23.2400"))
  ...
  expect_equal(
    (tbl_latex %>%
       fmt_percent(
         ...
         rows = num_1 < 1000) %>%
       render_formats_test(context = "latex"))[["num_1"]],
    c("1836.23", "2763.39", "93,729.00\\%", "64,300.00\\%", "21,223.20\\%",
      "0.00\\%", "-2,324.00\\%"))
...
test_that("the `fmt_datetime()` function works with conditional `rows`", {
  ...
  expect_equal(
    ...
    c("Thursday, March 25, 2010 19:45", "2015-06-12 09:25", "2016-01-15 14:38", "2012-08-07 12:31"))
