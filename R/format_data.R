  ...
  fmt(data = data,
      ...
      fns = list(
        html = function(x) {
          ...
          # Any values of `x` that are `NA` get `missing_text` as output; any
          # values that are not missing get `NA` as their output (meaning, the
          # existing output for that value, if it exists, should be inherited)
